...
$email=$_SESSION['login'];
  $sql ="SELECT user_password FROM USER WHERE user_email=:email and user_password=:password";
...
if($query -> rowCount() > 0)
{
$con="update USER set user_password=:newpassword where user_email=:email";
