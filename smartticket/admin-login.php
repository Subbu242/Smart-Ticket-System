...
$sql ="SELECT admin_email,admin_password,admin_name FROM ADMIN WHERE admin_email=:email and admin_password=:password";
...
$_SESSION['fname']=$results->admin_name;
$_SESISON['user_type'] = 'administrator';
