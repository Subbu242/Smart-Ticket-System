...
//echo ($email);
$sql ="SELECT emp_id,emp_name,emp_email,emp_station FROM EMPLOYEE WHERE  emp_email=:email";
...
<div class="row">
  <div class="col-sm-6">
    <br><br><br>
      ...
      <h4 align="center">STATION ID : <?php echo htmlentities($station);  ?></h4>
  </div>
  <div class="col-sm-4">
    <br><br><br>
    <h2 align="center">COUSTEMER RECHARGE</h2>
...
<div class="row">
  <div class="col-sm-6" align="center" style="font-weight: bold; font-size: 14pt">
                ...
                <h3 style="display: inline;">RIDE COST :<?php echo $_SESSION['cost']; ?> </h3>
                <img style="display: inline;" width="25pt" height="35pt" src="assets/images/fare-icon12.png">
                             
  </div>
  <div class="col-sm-4">
    <br>
    <h2 align="center">CREATE COUSTEMER ACCOUNT</h2>
   
  </div>
    <div class="col-sm-2">
    <p align="center"><a href="user-register.php" ><img width="80pt" height="80pt" src="assets/images/add-user.jpg"></a></p>
