...
$email=$_SESSION['login'];
  $sql ="SELECT emp_password FROM EMPLOYEE WHERE emp_email=:email and emp_password=:password";
...
if($query -> rowCount() > 0)
{
$con="update EMPLOYEE set emp_password=:newpassword where emp_email=:email";
...
<meta name="description" content=""><title>Smart Ticket Technology</title>
<!--Bootstrap -->
    ...
    <div class="row">
           <div class="col-md-12">
        		<div class="profile_wrap">
					<form name="chngpwd" method="post" onSubmit="return valid();" align="center">
