...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->admin_name); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            <li><a href="admin-account-details.php">Profile Settings</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          <li><a href="admin-index.php"><img " width="80pt" height="25pt" src="assets/images/train-logo.png"/></a></li>
          <li><a href="admin-index.php">Home</a>    </li>

          <li><a href="admin-mymetro.php">My Metro</a>
