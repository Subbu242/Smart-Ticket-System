...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->user_name); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <?php }
            ...
            echo "&nbsp;&nbsp;Welcome To Smart Ticket Technology";
        } ?>

      </div>
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          <li><a href="index.php"><img " width="80pt" height="25pt" src="assets/images/train-logo.png"/></a></li>
          <li><a href="index.php">Home</a>    </li>

          <li><a href="mymetro.php">My Metro</a>
