...
$edate=$res->travel_date_exit;
?>
<!DOCTYPE HTML>
<html lang="en">
<head>
<meta http-equiv="refresh" content="7;url=thankyou.php" />
...
<div class="row">
    <div class="col-sm-12" align="center">
            <h6 align="right" style="color: white; font-size:12pt"> <?php echo  date($edate);?> </h6>
...
<div class="row">
  ...
  <div class="col-sm-12">
            ...
            <div class="col-sm-6" align="center">
                ...
                <h4>Destination</h4>
                <h1><?php echo($res->destination_station_name) ?></h1>
                <hr>
                <h4> Exit Time</h4>
...
<div class="row">
  ...
  <div class="col-sm-6" align="center">
    <h3  style="display: inline;">This Ride Cost</h3>
    <h1  style="display: inline; color: #e74c3c; font-size:58pt; font-weight: bold;" ><?php echo($res->ride_cost) ?></h1>   
    <img style="display: inline;" width="80pt" height="120pt" src="../assets/images/fare-icon12.png" />  
  </div>

  
</div>
<img src="stopspread.gif" alt="COVID19" style="width:30%; height:330px; display: block;
  margin-left: 250px;
  margin-right: 700px; float:right;">
<!-- Scripts -->
