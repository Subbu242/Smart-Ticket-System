...
//echo ($email);
$sql ="SELECT emp_id,emp_name,emp_phone,emp_email FROM EMPLOYEE WHERE  emp_email=:email";
                                ...
                                <div class="row">
                                        <div class="account_details col-md-10 col-md-offset-1"
                                                ...
                                                <div >
                                                   ...
                                                   <a href="employee-update-password.php" ><button type="submit" class="btn btn-primary" name="button" value="" style="color: white; margin-left: 20px;">Change Password</button></a>    
                                                </div>
                                        </div>
                                </div>
                        </div>
